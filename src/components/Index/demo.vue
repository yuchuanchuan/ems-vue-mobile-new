  ...
  <div>
    ...
    <div class="box"><div class="tui" @click="prev"></div>EMS邮寄信息</div>
        ...
        <div class='fuceng' v-if="is_show" @click="show_img">
            <img src="../../img/chaxundingdan.png" v-image-preview >
            <img src="../../img/beijing.png" v-image-preview >
            <img src="../../img/banlixuzhi.png" v-image-preview >
        </div>
  </div>
</template>
<script>
    ...
    getOrderInfo(orderNum){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.dataForm.ownerNegative = "http://ems.tjeasytech.cn/mobile/" + data.data.ownerNegative
          this.dataForm.ownerPositive = "http://ems.tjeasytech.cn/mobile/" + data.data.ownerPositive
          this.dataForm.housingAuthority = "http://ems.tjeasytech.cn/mobile/" + data.data.housingAuthority
        } else {
          alert(data.msg)
        }
      })
