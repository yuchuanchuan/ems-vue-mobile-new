<template>
  <div class="content3">
    ...
    <div class="box">
      <div class="tui" @click="tui2"></div>订单支付
    </div>
    ...
    <div class="box3">
      ...
      <div class="item">
        ...
        <div class="info_rightForMore">{{detailRiskName}}</div>
      </div>
    </div>
...
<script>
  export default {
    data() {
      return {
        detailRiskName: '',
        addr: sessionStorage.getItem('handleAreaId'),
        hasFree: '',
        postTypes: [],
        handleAreas: [],
        postAddress: [],
    ...
    methods: {
      ...
      jump2() {
        if (this.dataForm.postType == "" || this.dataForm.postType == null || this.dataForm.postType == 'null') {
          ...
          if (this.dataForm.handleAreaId == '' || this.dataForm.handleAreaId == null || this.dataForm.handleAreaId ==
            'null') {
    ...
    created() {
      ...
      console.log('==============' + sessionStorage.getItem('isShow') + "-----------" + sessionStorage.getItem(
        'postRisk'))
